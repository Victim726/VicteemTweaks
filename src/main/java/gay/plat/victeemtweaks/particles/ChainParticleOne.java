...
public class ChainParticleOne extends Particle {
    ...
    protected ChainParticleOne(ClientWorld world, double x, double y, double z, Identifier texture, float red, float green, float blue) {
        super(world, x, y, z);
        this.texture = texture;
        this.model = new ChainModelOne(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(ChainModelOne.MODEL_LAYER));
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        //matrixStack.translate(owner.getX(), owner.getY(), owner.getZ());
        //matrixStack.multiply(RotationAxis.POSITIVE_Z.rotationDegrees(this.owner.age));
        //matrixStack.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(this.owner.age));
        ...
        //RotationAxis.of(new Vector3f(0,(float)Math.cos(30),(float)Math.sin(30))
    ...
    public static class DefaultFactory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new ChainParticleOne(world, x, y, z, this.texture, this.red, this.green, this.blue);
        }
    }
}
